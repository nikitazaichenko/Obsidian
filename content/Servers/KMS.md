...
Аналогичным образом вы можете активировать на KMS сервере корпоративные версии Microsoft Office 2021/2019/2016/2013. Для этого используются такие команды:  
cd %ProgramFiles%\Microsoft Office\Office(версия офиса)  
...
Generic Volume License Keys (GVLK) [https://learn.microsoft.com/en-us/windows-server/get-started/kms-client-activation-keys](https://learn.microsoft.com/en-us/windows-server/get-started/kms-client-activation-keys)  
...
Add-DnsServerResourceRecord -Srv -Name "_VLMCS._tcp" -ZoneName "you.domain.name" -DomainName "192.168.14.147" -Priority 0 -Weight 0 -Port 1688

Где 192.168.14.147 – IP адрес вашего Linux сервера со службой KMS, you.domain.name - ваш домен