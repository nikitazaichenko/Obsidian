...
[May 27, 2018](https://peterkleissner.com/2018/05/27/reverse-engineering-supermicro-ipmi/) | by [Kleissner](https://peterkleissner.com/author/kleissner/)

[![](https://peterkleissner.com/wp-content/uploads/2018/05/5.jpg)](https://peterkleissner.com/2018/05/27/reverse-engineering-supermicro-ipmi/)

Supermicro enforces a vendor-lock in on BIOS updates via IPMI, even though they publish the update files for free [here](https://www.supermicro.com/support/resources/bios_ipmi.php). The only free alternative is to time-travel to 1995 and boot from a DOS disk to supply the update. All other options (including the [Supermicro Server Manager](https://www.supermicro.com/products/nfo/ManagementSoftware.cfm)) require a license.

![](https://peterkleissner.com/wp-content/uploads/2018/05/Supermicro.jpg)
...
Anybody can create the license key on [https://cryptii.com/pipes/QiZmdA](https://cryptii.com/pipes/QiZmdA) by typing on the left side (select Bytes) the MAC address of the IPMI (the BMC), select in the middle HMAC and SHA-1, enter the secret key and on the right side the License Key will appear!

![](https://peterkleissner.com/wp-content/uploads/2018/05/DdXo0baX0AAkVUt.jpg)
...
![](https://peterkleissner.com/wp-content/uploads/2018/05/License-Key-Target.jpg)
...
**Update 9/15/2019**: Twitter user @zanejchua provided the link [https://cryptii.com/pipes/QiZmdA](https://cryptii.com/pipes/QiZmdA) which makes it easier to generate the code.
...
Supermicro offers the IPMI update files for free on [their website](https://www.supermicro.com/support/resources/bios_ipmi.php). You need to select your mainboard and download the IPMI update file. Among other files it will contain 1 large firmware blob, in this case “REDFISH_X10_366.bin”.

![](https://peterkleissner.com/wp-content/uploads/2018/05/Files.jpg)
...
![](https://peterkleissner.com/wp-content/uploads/2018/05/Extraction.jpg)
...
![](https://peterkleissner.com/wp-content/uploads/2018/05/Files-IPMI.jpg)
...
![](https://peterkleissner.com/wp-content/uploads/2018/05/Files-IPMI-2.jpg)

Here are the breadcrumbs I followed from the website part:

![](https://peterkleissner.com/wp-content/uploads/2018/05/1.jpg)

The response is XML with check set to 0 if invalid and 1 if valid (it’s weird that they do not use JSON instead):

![](https://peterkleissner.com/wp-content/uploads/2018/05/2.jpg)
...
![](https://peterkleissner.com/wp-content/uploads/2018/05/3.jpg)
...
![](https://peterkleissner.com/wp-content/uploads/2018/05/4.jpg)
...
![](https://peterkleissner.com/wp-content/uploads/2018/05/5.jpg)
